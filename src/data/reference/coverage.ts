...
export const COVERAGE_INVENTORY_REVISION = 'coverage-v5';
export const EXPECTED_COVERAGE_ENTRY_COUNT = 209;
...
export const COVERAGE_ENTRIES: CoverageEntry[] = [
  ...
  entry('spaetzle', 'Spaetzle batter', 'Spaetzle', 'pasta-noodles-wrappers', 'family.batters.griddle', 'P1'),
  ...
  entry('crepe', 'Crêpe', 'Κρέπα', 'pancakes-crepes-waffles', 'family.batters.thin-pan', 'P0'),
  entry('buckwheat-galette', 'Buckwheat galette', 'Γαλέτα φαγόπυρου', 'pancakes-crepes-waffles', 'family.batters.thin-pan', 'P1'),
  entry('american-pancake', 'American pancake', 'Αμερικανικό pancake', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P0'),
  entry('buttermilk-pancake', 'Buttermilk pancake', 'Pancake με buttermilk', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P0'),
  entry('dutch-baby', 'Dutch baby', 'Dutch baby', 'pancakes-crepes-waffles', 'family.batters.steam-puffed', 'P1'),
  entry('blini', 'Blini', 'Blini', 'pancakes-crepes-waffles', 'family.batters.fermented', 'P1'),
  entry('belgian-waffle', 'Belgian waffle', 'Βελγική βάφλα', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P0'),
  entry('brussels-waffle', 'Brussels waffle', 'Βάφλα Βρυξελλών', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('liege-waffle', 'Liège waffle', 'Βάφλα Λιέγης', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('japanese-souffle-pancake', 'Japanese soufflé pancake', 'Ιαπωνικό soufflé pancake', 'pancakes-crepes-waffles', 'family.batters.foam-leavened', 'P1'),
  entry('yorkshire-pudding', 'Yorkshire pudding', 'Yorkshire pudding', 'pancakes-crepes-waffles', 'family.batters.steam-puffed', 'P1'),
  entry('clafoutis', 'Clafoutis', 'Clafoutis', 'pancakes-crepes-waffles', 'family.batters.custard-like', 'P1'),
  entry('okonomiyaki', 'Okonomiyaki batter', 'Χυλός okonomiyaki', 'pancakes-crepes-waffles', 'family.batters.fritter', 'P1'),

  // First-party batter formulas captured from the internal exploration note.
  entry('batter-crepe-canonical', 'Crêpe batter', 'Μείγμα κρέπας', 'pancakes-crepes-waffles', 'family.batters.thin-pan', 'P1'),
  entry('batter-pancake-canonical', 'Pancake batter', 'Μείγμα pancake', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-waffle-canonical', 'Waffle batter', 'Μείγμα waffle', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('batter-buttermilk-canonical', 'Buttermilk pancake', 'Pancake με buttermilk', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-dutch-baby-canonical', 'Dutch baby batter', 'Μείγμα Dutch baby', 'pancakes-crepes-waffles', 'family.batters.steam-puffed', 'P1'),
  entry('batter-tempura-canonical', 'Tempura batter', 'Μείγμα tempura', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('batter-beer-canonical', 'Beer batter', 'Μείγμα μπύρας', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('batter-cake-pour-canonical', 'Pourable cake mixture', 'Ρευστό μείγμα για κέικ', 'cakes-quick-breads', 'family.batters.cake-adjacent', 'P1'),
  entry('batter-crepe-delicate', 'Delicate crêpe batter', 'Λεπτό μείγμα κρέπας', 'pancakes-crepes-waffles', 'family.batters.thin-pan', 'P1'),
  entry('batter-crepe-elastic', 'Elastic crêpe batter', 'Ελαστικό μείγμα κρέπας', 'pancakes-crepes-waffles', 'family.batters.thin-pan', 'P1'),
  entry('batter-crepe-tender', 'Tender crêpe batter', 'Τρυφερό μείγμα κρέπας', 'pancakes-crepes-waffles', 'family.batters.thin-pan', 'P1'),
  entry('batter-crepe-savoury', 'Savoury crêpe batter', 'Αλμυρό μείγμα κρέπας', 'pancakes-crepes-waffles', 'family.batters.thin-pan', 'P1'),
  entry('batter-pancake-fluffy', 'Fluffy pancake batter', 'Αφράτο μείγμα pancake', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-pancake-diner', 'Diner-style pancake batter', 'Μείγμα pancake τύπου diner', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-pancake-tender', 'Tender pancake batter', 'Τρυφερό μείγμα pancake', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-pancake-cakey', 'Cakey pancake batter', 'Μείγμα pancake τύπου cake', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-pancake-chewy', 'Chewy pancake batter', 'Μαστιχωτό μείγμα pancake', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-waffle-crisp', 'Crisp waffle batter', 'Τραγανό μείγμα waffle', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('batter-waffle-starch-heavy', 'Starch-heavy crisp waffle', 'Τραγανό waffle με πολύ άμυλο', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('batter-waffle-softer', 'Softer waffle batter', 'Μαλακότερο μείγμα waffle', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('batter-waffle-belgian', 'Belgian-style foam waffle', 'Waffle τύπου Belgian με αφρό', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('batter-dutch-baby-more-egg', 'Egg-rich Dutch baby', 'Dutch baby με περισσότερο αυγό', 'pancakes-crepes-waffles', 'family.batters.steam-puffed', 'P1'),
  entry('batter-dutch-baby-more-liquid', 'High-liquid Dutch baby', 'Dutch baby με περισσότερο υγρό', 'pancakes-crepes-waffles', 'family.batters.steam-puffed', 'P1'),
  entry('batter-tempura-light-brittle', 'Light brittle tempura', 'Ελαφριά εύθραυστη tempura', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('batter-tempura-thick', 'Thick tempura coating', 'Παχιά επικάλυψη tempura', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('batter-tempura-extra-crisp', 'Extra-crisp tempura', 'Extra-crisp tempura', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('batter-beer-thin', 'Thin crispy beer batter', 'Λεπτό τραγανό μείγμα μπύρας', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('batter-beer-thick', 'Thick pub-style beer batter', 'Παχύ μείγμα μπύρας τύπου pub', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('batter-waffle-cheese-herb', 'Cheese and herb waffle', 'Waffle με τυρί και βότανα', 'pancakes-crepes-waffles', 'family.batters.waffle', 'P1'),
  entry('batter-pancake-chocolate', 'Chocolate pancake', 'Pancake σοκολάτας', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-pancake-banana', 'Banana pancake', 'Pancake μπανάνας', 'pancakes-crepes-waffles', 'family.batters.griddle', 'P1'),
  entry('batter-clafoutis-seed', 'Clafoutis starting formula', 'Βασική φόρμουλα clafoutis', 'pancakes-crepes-waffles', 'family.batters.custard-like', 'P1'),
  entry('batter-vegetable-fritter-seed', 'Vegetable fritter starting formula', 'Βασική φόρμουλα για fritter λαχανικών', 'fried-doughs-batters', 'family.batters.fritter', 'P1'),
  entry('batter-sourdough-pancake-seed', 'Sourdough pancake starting formula', 'Βασική φόρμουλα pancake με προζύμι', 'pancakes-crepes-waffles', 'family.batters.fermented', 'P1'),
  entry('batter-souffle-pancake-seed', 'Soufflé pancake starting formula', 'Βασική φόρμουλα soufflé pancake', 'pancakes-crepes-waffles', 'family.batters.foam-leavened', 'P1'),
  ...
  entry('funnel-cake', 'Funnel cake', 'Funnel cake', 'fried-doughs-batters', 'family.batters.fritter', 'P1'),
  entry('fritter-batter', 'Fritter batter', 'Χυλός για τηγανίτες/λουκουμάδες', 'fried-doughs-batters', 'family.batters.fritter', 'P1'),
  entry('tempura-batter', 'Tempura batter', 'Χυλός tempura', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('pakora-batter', 'Pakora batter', 'Χυλός pakora', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  entry('onion-ring-batter', 'Onion-ring batter', 'Χυλός για onion rings', 'fried-doughs-batters', 'family.batters.coating', 'P1'),
  ...
  entry('injera', 'Injera', 'Injera', 'gluten-free-alternative', 'family.batters.fermented', 'P1'),
  entry('dosa', 'Dosa', 'Dosa', 'gluten-free-alternative', 'family.batters.fermented', 'P1'),
  entry('idli', 'Idli', 'Idli', 'gluten-free-alternative', 'family.batters.fermented', 'P1'),
  entry('appam', 'Appam', 'Appam', 'gluten-free-alternative', 'family.batters.fermented', 'P1'),
  ...
  entry('gluten-free-pancake', 'Gluten-free pancake', 'Pancake χωρίς γλουτένη', 'gluten-free-alternative', 'family.batters.griddle', 'P0'),
  entry('gluten-free-crepe', 'Gluten-free crêpe', 'Κρέπα χωρίς γλουτένη', 'gluten-free-alternative', 'family.batters.thin-pan', 'P1'),
];
